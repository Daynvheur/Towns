...
public class TradePanel {
    ...
    public void selectItemToBuy(int iIndex) {
        ...
        if (p3dFlags.y > 0) {
            boolean bControl = p3dFlags.y > 99 && (KeyAdapter.isKeyDown(KeyAdapter.KEY_LCONTROL) || KeyAdapter.isKeyDown(KeyAdapter.KEY_RCONTROL));
            boolean bShift = p3dFlags.y > 9 && (KeyAdapter.isKeyDown(KeyAdapter.KEY_LSHIFT) || KeyAdapter.isKeyDown(KeyAdapter.KEY_RSHIFT));
