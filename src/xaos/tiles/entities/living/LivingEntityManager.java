...
public class LivingEntityManager {
    ...
    private static void loadXML(String sXMLName, boolean bLoadingMain) {
        try {
            ...
            Log.error(Messages.getString("LivingEntityManager.11") + sXMLName + Messages.getString("LivingEntityManager.12") + e.toString() + "]", "LivingEntityManager"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            Game.exit();
        }
    }
